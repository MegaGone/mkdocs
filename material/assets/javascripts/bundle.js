(() => {
  ...
  function watchElementFocus(el) {
    return merge(fromEvent(document.body, "focusin"), fromEvent(document.body, "focusout")).pipe(map(() => {
  ...
  function watchContentTabs(el) {
    return merge(...getElements(":scope > input", el).map((input) => fromEvent(input, "change").pipe(mapTo({
  ...
  var SearchMessageType = /* @__PURE__ */ ((SearchMessageType2) => {
