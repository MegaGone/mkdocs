...
### 7.3.6 <small>_ Septiembre 30, 2021</small> { id="7.3.6" }

- Added support for adding titles to code blocks

### 7.3.5 <small>_ Septiembre 27, 2021</small> { id="7.3.5" }
...
### 7.3.4 <small>_ Agosto 17, 2021</small> { id="7.3.4" }
...
### 7.3.3 <small>_ Julio 11, 2021</small> { id="7.3.3" }
...
### 7.3.2 <small>_ Junio 6, 2021</small> { id="7.3.2" }
...
### 7.3.1 <small>_ Mayo 2, 2021</small> { id="7.3.1" }
...
### 7.3.0 <small>_ Abril 23, 2021</small> { id="7.3.0" }

- Added support for sticky navigation tabs
- Added support for section index pages
- Added support for removing generator notice

### 7.2.8 <small>_ Marzo 20, 2021</small> { id="7.2.8" }
